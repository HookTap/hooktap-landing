          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col gap-3">
                ...
                <Link href={{pathname: "/", hash: "overview"}} className="text-sm text-white/50 hover:text-white">{tGlobal("nav.overview")}</Link>
                <Link href={{pathname: "/", hash: "features"}} className="text-sm text-white/50 hover:text-white">{tGlobal("nav.features")}</Link>
                <Link href={{pathname: "/", hash: "why"}} className="text-sm text-white/50 hover:text-white">{tGlobal("nav.why")}</Link>
                <Link href={{pathname: "/", hash: "pricing"}} className="text-sm text-white/50 hover:text-white">{tGlobal("nav.pricing")}</Link>
              </div>
              <div className="flex flex-col gap-3">
