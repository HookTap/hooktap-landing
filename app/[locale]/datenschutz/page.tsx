  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-14 text-white md:px-8">
      ...
      <p className="mt-4 text-white/65">
        Hinweis: Bitte durch eine rechtlich geprüfte Datenschutzerklärung ersetzen.
      </p>
      ...
      <section className="neo-card mt-5 rounded-2xl p-6">
        ...
        <p className="mt-3 text-white/75">
          Bei der Nutzung von HookTap können technische Daten, Webhook-Inhalte und
          Nutzungsdaten verarbeitet werden, soweit dies für den Betrieb der App erforderlich ist.
        </p>
      </section>
      ...
      <section className="neo-card mt-5 rounded-2xl p-6">
        ...
        <p className="mt-3 text-white/75">
          ...
          oder gesetzliche Pflichten dies vorsehen.
        </p>
      </section>
