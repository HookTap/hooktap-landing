  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-14 text-white md:px-8">
      ...
      <p className="mt-4 text-white/65">
        Hinweis: Bitte durch rechtlich geprüfte Nutzungsbedingungen ersetzen.
      </p>

      <section className="neo-card mt-10 rounded-2xl p-6">
        <h2 className="text-xl font-semibold">1. Geltungsbereich</h2>
        <p className="mt-3 text-white/75">
          Diese Bedingungen regeln die Nutzung der HookTap-App und der zugehörigen Dienste.
        </p>
      </section>
      ...
      <section className="neo-card mt-5 rounded-2xl p-6">
        ...
        <p className="mt-3 text-white/75">
          HookTap stellt Webhook-Empfang und Push-Benachrichtigungen auf iOS bereit. Der
          Leistungsumfang kann je nach Tarif variieren.
        </p>
      </section>
      ...
      <section className="neo-card mt-5 rounded-2xl p-6">
        ...
        <p className="mt-3 text-white/75">
          Die Nutzung darf nicht rechtswidrig sein. Insbesondere dürfen keine schädlichen oder
          missbräuchlichen Inhalte übermittelt werden.
        </p>
      </section>
      ...
      <section className="neo-card mt-5 rounded-2xl p-6">
        ...
        <p className="mt-3 text-white/75">
          Es gelten die gesetzlichen Haftungsregelungen. Eine Haftung für leichte Fahrlässigkeit
          ist, soweit zulässig, ausgeschlossen.
        </p>
      </section>
